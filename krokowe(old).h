...
#define OPOZNIJ_MS_WYSOKIE 312 //312 przy 16mhz, 19=1mhz (turbo mode), wolniej to np, obie wartosci x2
#define OPOZNIJ_MS_NISKIE 437 //437 przy 16mhz 27=1mhz (turbo mode)
